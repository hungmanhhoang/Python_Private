...
if __name__ == '__main__':
    ...
    print("\nDanh sach ban: ")
    khmt = Ban("20221BS6024004", "Mỹ thuật đại cương", h1, [h1, h2, h3, h4, h5])
    print(khmt)
    
    print("\nDanh sach ban: ")
    ktmp = Ban("20221BS6024004", "Mỹ thuật", h6, [h6, h7, h8, h9, h10])
    print(ktmp)
    
    # idHiter = input("Nhap id hiter can xoa: ")
    # for ban in [khmt, ktmp]:
    #     if ban.idHiter == idHiter:
    #         ban.xoa(idHiter)
    #         break
